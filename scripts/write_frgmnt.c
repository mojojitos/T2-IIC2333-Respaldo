...
// necesita ejecutar dsos de pob_fragmnt.c y/o read_frgmnt.c adicional.
// requiere archivos locales nuevo_tiny_0.txt, nuevo_tiny_2.txt, nuevo_tiny_4.txt y nuevo_grande.txt
